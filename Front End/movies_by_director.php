...
//name="V Kohli";
var api = "http://localhost:3000/api/movies/director/";
var apid = api.concat(director);

document.getElementById("id").innerHTML = "Details of the movie directed by "+ director;
